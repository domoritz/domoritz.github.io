...
<figure>
<div class="flex-rows">
<figure><img src="{{ '/images/posts/vsup/polls-bivariate-map.avif' | relative_url }}" alt="A bivariate choropleth map of the US showing Clinton lead against margin of error, with a square legend"></figure>
<figure><img src="{{ '/images/posts/vsup/polls-vsup-map.avif' | relative_url }}" alt="A bivariate map (left) and a Value-Suppressing Uncertainty Palette (VSUP, right), showing polling data for US states before the 2016 Presidential Election"></figure>
</div>
...
<figure>
<img src="{{ '/images/posts/vsup/sasquatch-map.avif' | relative_url }}" alt="A bivariate map from Joshua Stevens that shows both population density and sasquatch sightings in the continental US">
...
<figure>
<img src="{{ '/images/posts/vsup/bavarian-land-use-map.avif' | relative_url }}" alt="One of the earliest surviving examples of a bivariate color map, an 1874 map of land use from Bavarian statistician Georg Mayr">
...
<figure>
<img src="{{ '/images/posts/vsup/tree-quantization.avif' | relative_url }}" alt="A traditional bivariate map assigns one unique output (in this case, a color), to every combination of the two variables of interest">
...
<figure>
<div class="flex-rows">
<figure><img src="{{ '/images/posts/vsup/snap-value-map.avif' | relative_url }}" alt="A choropleth map of the US showing the percentage of households using SNAP, with a square legend"></figure>
<figure><img src="{{ '/images/posts/vsup/snap-vsup-map.avif' | relative_url }}" alt="Standard value map (left) and VSUP (right) showing the percentage of US households using the Supplemental Nutrition Assistance Program"></figure>
</div>
