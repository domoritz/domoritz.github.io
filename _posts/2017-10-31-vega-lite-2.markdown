...
We are excited to announce the official version 2 release of [Vega-Lite](https://vega.github.io/vega-lite-v2/), a high-level language for *rapidly creating interactive visualizations*.
...
The *layer*, *facet*, *concat*, and *repeat* operators comprise a *view algebra* for creating a wide range of multi-view visualizations. For more about details about flexible chart composition, see the [Vega-Lite documentation](https://vega.github.io/vega-lite-v2/docs/composition.html).
...
More details about Vega-Lite’s interaction primitives can be found in [the documentation](https://vega.github.io/vega-lite-v2/docs/selection.html). For a more formal treatment, see the (best paper winning) [InfoVis 2016 research paper on the Vega-Lite language design](https://idl.uw.edu/papers/vega-lite).
