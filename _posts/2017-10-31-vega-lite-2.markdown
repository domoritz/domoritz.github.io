...
<figure>
<img src="{{ '/images/posts/vega-lite-2/weather-composition.avif' | relative_url }}" alt="Three charts that show different weather measures throughout the year in Seattle and New York">
...
<figure>
<img src="{{ '/images/posts/vega-lite-2/moving-average.avif' | relative_url }}" alt="An interactive moving average in Vega-Lite 2">
...
<figure>
<img src="{{ '/images/posts/vega-lite-2/crossfilter.avif' | relative_url }}" alt="A crossfilter interaction in Vega-Lite 2">
